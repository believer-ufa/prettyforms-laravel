...
Единственное, чего еще не сделано - это полноценная документация ко всему этому, но это, я надеюсь, это только дело времени. Сама документация уже давным-давно лежит в моей голове, так как я работал над этими формами уже несколько лет в разных проектах, просто она не оформлена физически. На данный же момент мною написана [инструкция по установке и подключению компонента к фреймворку](https://github.com/believer-ufa/prettyforms-laravel), а также создано [полноценное рабочее приложение](https://github.com/believer-ufa/prettyforms-laravel5-app), которое вы можете установить на свой компьютер и поиграться в нём формами регистрации, создания и редактирования пользователей, изменением списка ролей, а также создавать и редактировать статьи сайта.
